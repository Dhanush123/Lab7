...
int main()
{
    ...
    cout << "Description: This program calculates the change due for unlimited user given values of cash payment and tendered amount." << endl;
    cout << endl;
    int cashPayment;
    int amountTendered;
    int n = 0;
    ...
    } while(cashPayment !=0 || cashPayment !=0);
}
